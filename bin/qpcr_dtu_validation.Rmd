...
txdb_flair_dump <- as.list(txdb_gencode)
...
plot.transcripts <- function(gene_id) {
    ...
    primer_info <- primer_stats %>% 
        ...
        dplyr::select(mgi_symbol, primer_name, amplified_region) %>% 
    ...
    plotTracks(list(gtrack,
            ...
            cdna_warm, cdna_cold,
            atrack_gencode, atrack_flair, primerTrack),
