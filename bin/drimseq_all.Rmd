...
dir.create("../res/dtu_all", showWarnings = FALSE)
...
res_gene %>% 
    ...
    dplyr::rename(ensembl_gene_id_version = "gene_id") %>% 
    left_join(annotation_gene, by = "ensembl_gene_id_version") %>% 
    write_csv("../res/dtu_all/genelevel_drimseq_dtu.csv.gz")
...
res_tx %>% 
    ...
    as_tibble() %>% 
    arrange(adj_pvalue) %>% 
    write_csv("../res/dtu_all/txlevel_drimseq_dtu.csv.gz")
```
...
res_stageR %>% 
    write_csv("../res/dtu_all/stageR_drimseq_dtu.csv.gz")
