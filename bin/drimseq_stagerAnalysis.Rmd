...
knitr::opts_chunk$set(echo = FALSE, message = FALSE, warning = FALSE,
    cache = FALSE, fig.width = 3.4 * 2, fig.asp = 0.7, out.width = 800)
```
...
for (ens_gene_id in "ENSMUSG00000056228.10") { #gene_ids
    ...
    pl1 <- df2 %>% 
        ...
        scale_x_discrete(labels = c("5ae7eec5-5305-4d10-b5ba-46aa6a69568f" = "Cars2-FL",
                                    "f08a5a5b-5e85-4d78-a6c2-acd7764ef517" = "Cars2-AT")) +
        xlab(NULL)
