...
plot.transcripts_1 <- function(gene_id, extend.right = 250, extend.left = 250) {
...
plot.transcripts_2 <- function(gene_id) {
   ...
   options(ucscChromosomeNames = FALSE)
    ...
    plotTracks(list(gtrack,
        ...
        min.height = 0,
        sashimiScore = 5,
        sizes = c(.25, rep(1, 4), rep(1, 2)))
}
```

```{r}
plot.transcripts_1("ENSMUSG00000024981.6")
plot.transcripts_1("ENSMUSG00000087382.7", extend.right = 5500)
```

```{r}
plot.transcripts_2("ENSMUSG00000020654.15")
```
