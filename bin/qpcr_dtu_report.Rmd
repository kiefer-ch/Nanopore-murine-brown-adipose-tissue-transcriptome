...
primer_stats <- read_csv(snakemake@input[["primer_stats"]], show_col_types = FALSE) %>%
...
# plot function
plot.transcripts <- function(gene_id, max_cov_illumina = 5, lwd_sashimi_max = 10) {
...
```{r loop, results="asis", fig.width = 6.85, fig.asp = 1}
gene_ids <- tibble(
    symbol =
        c("Acsl5", "Adcy3", "Adtrp",
          "Aldoa", "Cars2", "Dipk1b",
