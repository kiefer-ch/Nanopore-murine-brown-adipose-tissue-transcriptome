...
df_tx %>% 
    ...
    mutate(same_transcript = if_else(ensembl_transcript_id_version == ensembl_transcript_id_version[type == "primary"], TRUE, FALSE),
           same_gene = if_else(ensembl_gene_id_version == ensembl_gene_id_version[type == "primary"], TRUE, FALSE),
    ...
    mutate(
        supplementary_type = if_else(
            !same_gene, "diff_gene",
            if_else(!same_transcript, "diff_transcript",
