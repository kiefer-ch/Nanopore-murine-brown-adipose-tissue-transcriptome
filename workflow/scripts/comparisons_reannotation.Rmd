...
# add class code
dataset_lookup <- c("illumina_ref", "illumina_illumina_stringtie"  "illumina_cdna_flair"          "illumina_teloprime_stringtie" "cdna_ref"                     "cdna_illumina_stringtie"      "cdna_cdna_flair"             
[8] "cdna_teloprime_stringtie" )

names(dataset_lookup) <- c("r", "",
